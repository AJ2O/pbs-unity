...
namespace PBS.Networking
{
    ...
    public class Player : NetworkBehaviour
    {
        ...
        {
            string text = "";
            PBS.Data.Item itemData = Items.instance.GetItemData(bEvent.itemID);
            if (IsTrainerPlayer(bEvent.playerID))
            {
        ...
        public IEnumerator ExecuteEvent_PokemonChangeForm(Battle.View.Events.PokemonChangeForm bEvent)
        {
            ...
            PBS.Data.Pokemon preFormData = PBS.Databases.Pokemon.instance.GetPokemonData(bEvent.preForm);
            PBS.Data.Pokemon postFormData = PBS.Databases.Pokemon.instance.GetPokemonData(bEvent.postForm);
        ...
        {
            PBS.Battle.View.WifiFriendly.Pokemon pokemon = myModel.GetMatchingPokemon(bEvent.pokemonUniqueID);
            Ability abilityData = Abilities.instance.GetAbilityData(bEvent.abilityID);
        ...
        {
            PBS.Battle.View.WifiFriendly.Pokemon pokemon = myModel.GetMatchingPokemon(bEvent.pokemonUniqueID);
            Move moveData = Moves.instance.GetMoveData(bEvent.moveID);
        ...
        private string RenderMessageTrainer(int playerID, int teamPerspectiveID = -1, string baseString = "")
        {
            ...
            PBS.Data.GameText textData = 
                (trainer.teamPos != teamPerspectiveID)? PBS.Databases.GameText.instance.GetGameTextData("trainer-perspective-opposing")
        ...
        private string RenderMessageTeam(int teamID, int teamPerspectiveID = -1, string baseString = "")
        {
            ...
            PBS.Data.GameText textData = 
                (team.teamID != teamPerspectiveID)? PBS.Databases.GameText.instance.GetGameTextData("team-perspective-opposing")
