...
public class BTLUIPanelCommand : BTLUIPanel
{
    [Header("Prompts")]
    ...
    public void SetCommands(Pokemon pokemon, IEnumerable<BattleCommandType> commandList)
    {
    ...
    public void PromptPokemon(Pokemon pokemon)
    {
