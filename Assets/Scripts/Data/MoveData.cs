...
namespace PBS.Data
{
    public class MoveData
    {
        ...
        private List<Databases.Effects.Moves.MoveEffect> p_effectsNew { get; set; }
        public List<Databases.Effects.Moves.MoveEffect> effectsNew
        {
            get
            {
                if (combineBaseEffects && !string.IsNullOrEmpty(baseID))
                {
                    List<Databases.Effects.Moves.MoveEffect> unionEffects = new List<Databases.Effects.Moves.MoveEffect>();
        ...
        private List<Databases.Effects.Moves.MoveEffect> p_ZEffectsNew { get; set; }
        public List<Databases.Effects.Moves.MoveEffect> ZEffectsNew
        {
            get
            {
                if (combineBaseEffects && !string.IsNullOrEmpty(baseID))
        ...
        public MoveData(
            ...
            Databases.Effects.Moves.MoveEffect[] effectsNew = null,

            int ZBasePower = 0,
            Databases.Effects.Moves.MoveEffect[] ZEffectsNew = null,
            ...
            int MaxPower = 0)
        {
            ...
            this.effectsNew = new List<Databases.Effects.Moves.MoveEffect>();
            if (effectsNew != null)
            {
                List<Databases.Effects.Moves.MoveEffect> addableEffects = new List<Databases.Effects.Moves.MoveEffect>();
            ...
            this.ZEffectsNew = new List<Databases.Effects.Moves.MoveEffect>();
            if (ZEffectsNew != null)
            {
                List<Databases.Effects.Moves.MoveEffect> addableEffects = new List<Databases.Effects.Moves.MoveEffect>();
        ...
        public List<Databases.Effects.Moves.MoveEffect> GetEffectsNewFiltered(MoveEffectTiming timing)
        {
            List<Databases.Effects.Moves.MoveEffect> effects = new List<Databases.Effects.Moves.MoveEffect>();
        ...
        public List<Databases.Effects.Moves.MoveEffect> GetEffectsNew(MoveEffectType effectType, bool forceUnique = false)
        {
            List<Databases.Effects.Moves.MoveEffect> effects = new List<Databases.Effects.Moves.MoveEffect>();
            for (int i = 0; i < effectsNew.Count; i++)
            {
        ...
        public Databases.Effects.Moves.MoveEffect GetEffectNew(MoveEffectType effectType, bool forceUnique = false)
        {
            List<Databases.Effects.Moves.MoveEffect> effectList = GetEffectsNew(effectType, forceUnique);
        ...
        public List<Databases.Effects.Moves.MoveEffect> GetZEffects()
        {
            return new List<Databases.Effects.Moves.MoveEffect>(ZEffectsNew);
        }
    }
}