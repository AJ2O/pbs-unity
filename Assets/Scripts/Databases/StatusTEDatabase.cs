...
public class StatusTEDatabase
{
    //create an object of SingleObject
    private static StatusTEDatabase singleton = new StatusTEDatabase();

    //make the constructor private so that this class cannot be
    //instantiated
    private StatusTEDatabase() { }

    //Get the only object available
    public static StatusTEDatabase instance
    {
        get
        {
            return singleton;
