...
public class StatusPKDatabase
{
    //create an object of SingleObject
    private static StatusPKDatabase singleton = new StatusPKDatabase();

    //make the constructor private so that this class cannot be
    //instantiated
    private StatusPKDatabase() { }

    //Get the only object available
    public static StatusPKDatabase instance
    {
        get
        {
            return singleton;
